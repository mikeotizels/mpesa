 ...
 * 
 * This is the Lite Version of the Mikeotizels implementations of the various 
 * Safaricom's M-PESA REST APIs dubbed DARAJA APIs. The APIs documentation is 
 * available online at Safaricom Developers' Portal.
...
class Mpesa 
{
     ...
     *
     * @since 1.0.0
     * @since 2.0.0 Migrated from the C2B v1 endpoint to C2B v2 endpoint.
     *
     * @method POST
     * 
     * @param array $params Request parameters.
     ...
     * 
     * @since 1.2.0
     * @since 2.0.0 Added the $method parameter.
     *
    ...
    {          
        ...
        if (!file_exists($publicKeyFile)) {
            throw new \Exception("The M-PESA API certificate file '{$certFile}' can't be found in the certificates directory.");
        }
     ...
     * @since 1.5.0
     *
     * @param integer $errno Error number from curl_errno(). Not currently used.
     * @param string  $error Error message from curl_error().
     *
     * @throws Exception
     *
     * @return void
